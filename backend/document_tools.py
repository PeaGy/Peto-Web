...
SCHEMA = {
    ...
    'description': 'Tạo tệp Word DOCX hoặc PDF thật, lưu riêng theo tài khoản và hiện thẻ xem trước/tải ngay trong chat. Gọi khi người dùng yêu cầu tạo/xuất/gửi file; không chỉ dán nội dung vào lời nhắn. Không dùng chỉ để đọc, tóm tắt hay giải thích cách tạo file.',
    'parameters': {
        'type': 'object', 'additionalProperties': False,
        'properties': {
            'title': {'type': 'string', 'description': 'Tên tài liệu ngắn, không có phần mở rộng.'},
            'content': {'type': 'string', 'description': 'Toàn bộ nội dung tài liệu dạng Markdown, bắt đầu bằng tiêu đề. Không chứa lời chào, hướng dẫn bấm nút, thông báo tạo xong hay code fence bọc toàn bài. Có thể dùng bảng tối đa 8 cột. Chưa hỗ trợ ảnh, LaTeX, emoji.'},
