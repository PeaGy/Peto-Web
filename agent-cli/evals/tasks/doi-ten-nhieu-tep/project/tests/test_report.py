...
ITEMS = [Item(sku="A-1", name="Bút", qty=3, price=5000), Item(sku="B-2", name="Vở", qty=40, price=18000)]


class ReportTest(unittest.TestCase):
    def test_low_stock(self):
        self.assertEqual([item.sku for item in report.low_stock(ITEMS, 5)], ["A-1"])
